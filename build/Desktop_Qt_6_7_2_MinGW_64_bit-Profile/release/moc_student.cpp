...
void Student::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->reqDelMe((*reinterpret_cast< std::add_pointer_t<Student*>>(_a[1]))); break;
        ...
        case 0:
            ...
            default: *reinterpret_cast<QMetaType *>(_a[0]) = QMetaType(); break;
            case 0:
                *reinterpret_cast<QMetaType *>(_a[0]) = QMetaType::fromType< Student* >(); break;
            }
            break;
        }
        ...
        {
            using _t = void (Student::*)(Student * );
            if (_t _q_method = &Student::reqDelMe; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &Student::dataChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Student::reqDelMe(Student * _t1)
{
