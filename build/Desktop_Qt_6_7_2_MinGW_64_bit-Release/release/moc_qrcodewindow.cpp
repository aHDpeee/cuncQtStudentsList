...
struct qt_meta_stringdata_CLASSQrCodeWindowENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQrCodeWindowENDCLASS = QtMocHelpers::stringData(
    "QrCodeWindow",
    "update",
    "",
    "text",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQrCodeWindowENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QrCodeWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_CLASSQrCodeWindowENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQrCodeWindowENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQrCodeWindowENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<QrCodeWindow, std::true_type>,
        // method 'update'
...
void *QrCodeWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQrCodeWindowENDCLASS.stringdata0))
